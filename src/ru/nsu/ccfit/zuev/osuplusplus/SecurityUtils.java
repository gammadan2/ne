...
public final class SecurityUtils {
    ...
    private static final String flashlightCursorHash =
        "3b3afff3dab87f214053ded3163ff4e91cc3474e";
    private static final String flashlightDimLayerHash =
        "59dfd45eecdfbeb7a91761a7af4b3e0162d13e9f";
    ...
    public static byte[] getSecretKey() {
        if (secretBuffer == null) {
            ...
            for (int i = 0; i < COMPRESSED.length; i++) {
                ...
                highest =
                    (COMPRESSED[i] & (0xff ^ BIT_MASK[index])) >> (7 - index);
            }
        }
        return secretBuffer;
    }
    ...
    public static boolean verifyFileIntegrity(Context context) {
        return (
            verifyFileIntegrity(
                ...
                flashlightCursorHash
            ) &&
            verifyFileIntegrity(
                context,
                "flashlight_dim_layer.png",
                flashlightDimLayerHash
            )
        );
    }
    ...
    private static boolean verifyFileIntegrity(
        ...
        try (var in = context.getAssets().open(fileName)) {
            ...
            Log.e(
                "SecurityUtils",
                "Failed to check file integrity for " + fileName,
                e
            );
